 <template>
    <div id="app" class="antialiased text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        <div class="min-h-screen flex justify-center pt-20 md:pt-0 md:items-center">
            <InformationCard />
        </div>
